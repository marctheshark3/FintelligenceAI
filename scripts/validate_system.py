...
class SystemValidator:
    ...
    async def validate_full_workflow(self) -> Dict:
        ...
        try:
            ...
            research_response = await self.client.post(
                ...
                json={"query": "How to create a basic ErgoScript contract?", "max_results": 2}
            )
            
            if research_response.status_code != 200:
                return {"status": "❌ FAILED", "step": "research", "error": research_response.text}
            ...
            if generation_response.status_code != 200:
                return {"status": "❌ FAILED", "step": "generation", "error": generation_response.text}
            
            # Step 3: Validate generated code
            try:
                generated_code = generation_response.json().get("generated_code", "val placeholder = 1")
            except:
            ...
            return {
                "status": "✅ PASSED" if validation_response.status_code == 200 else "❌ FAILED",
                "steps_completed": 3,
    ...
    async def run_full_validation(self) -> Dict:
        ...
        validation_results["overall_status"] = "✅ ALL TESTS PASSED" if all_passed else f"❌ {passed_tests}/{total_tests} TESTS PASSED"
