...
from .processor import DocumentProcessor, ErgoScriptProcessor, DocumentChunk
...
class KnowledgeBaseManager:
    ...
    async def setup_ergoscript_knowledge_base(self) -> IngestionResult:
        ...
        try:
            ...
            logger.info(f"Processed {result.documents_processed} documents into {result.chunks_created} chunks")
    ...
    async def _store_chunks(self, chunks: List[DocumentChunk]) -> int:
        ...
        for i in range(0, len(chunks), batch_size):
            ...
            try:
                ...
                logger.debug(f"Stored batch {i//batch_size + 1}: {len(documents)} chunks")
    ...
    async def get_knowledge_base_stats(self) -> Dict:
        ...
        try:
            ...
            return {
                "collection_name": collection_stats.get("collection_name", "ergoscript_examples"),
...
class IngestionPipeline:
    ...
    async def run_custom_ingestion(
        ...
        collection_name: str = "custom_documents"
    ) -> IngestionResult:
