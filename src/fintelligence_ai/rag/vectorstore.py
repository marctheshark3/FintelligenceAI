...
class VectorStoreManager:
    ...
    def get_document(self, document_id: str) -> Optional[Document]:
        ...
        try:
            ...
            if results["ids"] and results["ids"][0]:
                ...
                embedding = (
                    results["embeddings"][0][0] if results["embeddings"] else None
                )
    ...
    def _reconstruct_metadata(self, metadata_dict: dict[str, Any]) -> DocumentMetadata:
        ...
        from .models import ComplexityLevel, DocumentCategory, DocumentSource
        ...
        return DocumentMetadata(
            ...
            tags=metadata_dict.get("tags", "").split(",")
            if metadata_dict.get("tags")
            else [],
            last_updated=datetime.fromisoformat(
                metadata_dict.get("last_updated", datetime.utcnow().isoformat())
            ),
