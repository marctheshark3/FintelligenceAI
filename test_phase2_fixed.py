...
def test_core_imports():
    ...
    try:
        from fintelligence_ai.core.optimization import DSPyOptimizer, OptimizationConfig
        from fintelligence_ai.core.evaluation import EvaluationFramework, EvaluationMetrics
...
def test_model_instantiation():
    ...
    try:
        from fintelligence_ai.core.evaluation import EvaluationMetrics, EvaluationResult, EvaluationCategory
        from fintelligence_ai.core.optimization import OptimizationConfig, OptimizationStrategy
...
async def test_async_evaluation():
    ...
    try:
        ...
        logger.info(f"✓ Async evaluation completed - Accuracy: {result.metrics.accuracy:.3f}")
